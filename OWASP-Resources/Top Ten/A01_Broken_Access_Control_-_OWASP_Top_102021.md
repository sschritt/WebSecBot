...
Common Weakness Enumerations (CWEs) included are _CWE-200: Exposure of
Sensitive Information to an Unauthorized Actor_ , _CWE-201: Insertion of
Sensitive Information Into Sent Data_ , and _CWE-352: Cross-Site Request
Forgery_.
...
function outside the user's limits. Common access control vulnerabilities
include:
...
account number they want. If not correctly verified, the attacker can access
any user's account.
